...
class Comment(models.Model):
    ...
    generation = models.ForeignKey(Generation, related_name='comments', null=True, on_delete=models.SET_NULL)
    comment = models.CharField()
    time = models.DateTimeField(auto_now_add=True)
                                
class Favorite(models.Model):
    user = models.ForeignKey(User, related_name='user_favorites', null=True, on_delete=models.SET_NULL)
    generation = models.ForeignKey(Generation, related_name='favorites', null=True, on_delete=models.SET_NULL)
    time = models.DateTimeField(auto_now_add=True)