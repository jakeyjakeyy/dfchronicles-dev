...
class Generate(APIView):
    ...
    prompt = "Imagine you're an archivist from the game Dwarf Fortress. Magic is not a prominent force. Your task is to craft an engaging narrative that brings this extraordinary realm to life, while adhering to its established lore. Infuse vivid details to captivate readers and take them on a journey through this realm. If an object has two names, include the second Dwarvish name."
