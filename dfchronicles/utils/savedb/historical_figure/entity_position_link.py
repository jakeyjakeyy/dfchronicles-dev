def save_entity_position_link(element, hf):
    ...
    if position_id:
        return {'entity_position_link': entity_position_link.id, 'position_id': position_id, 'civ_id': civ_id}
    elif civ_id:
        return {'entity_position_link': entity_position_link.id, 'civ_id': civ_id}
